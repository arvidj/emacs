...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("1781e8bccbd8869472c09b744899ff4174d23e4f7517b8a6c721100288311fa5"
     ...
     "40670c1a2158e4387407ca1c8a06c03153baca5016e3f9f23d7fb4157e408960"
 ...
 '(flycheck-sh-shellcheck-executable
   "/home/arvid/.cabal/bin/shellcheck")
 '(flyspell-abbrev-p t)
 ...
 '(safe-local-variable-values
   '((sh-basic-offset 2)
     ...
     (coq-prog-name
      .
      "/home/arvid/dev/nomadic-labs/mi-cho-coq/coq8.8.0/_opam/bin/coqtop")
     (coq-compiler
      .
      "/home/arvid/dev/nomadic-labs/mi-cho-coq/coq8.8.0/_opam/bin/coqc")
     (coq-prog-name
      .
      "/home/arvid/dev/nomadic-labs/mi-cho-coq/coq8.0.8/_opam/bin/coqtop")
     (coq-compiler
      .
      "/home/arvid/dev/nomadic-labs/mi-cho-coq/coq8.0.8/_opam/bin/coqc")
     ...
     (eval add-hook
           ...
           'arvid-wl/magit-commit-msg-add-week-no)
     ...
     (eval
      ...
      (make-local-variable 'compile-command)
      (format
       "cd %s/docs ; poetry run sphinx-build -b html . \"_build\" %s -q"
     ...
     (eval
      ...
      (make-local-variable 'compile-command)
      (format
       "cd %s/docs ; poetry run sphinx-build -b html . \"_build\" %s -E"
       (projectile-project-root)
       (if buffer-file-name
           (shell-quote-argument buffer-file-name))))
     (eval
      ...
      (make-local-variable 'compile-command)
      (format
       "cd %s ; poetry run sphinx-build -b html . \"_build\" %s -E"
       (projectile-project-root)
       (if buffer-file-name
           (shell-quote-argument buffer-file-name))))
     (coq-prog-name
      .
      "/home/arvid/dev/nomadic-labs/mi-cho-coq/coq8.08/_opam/bin/coqtop")
     (coq-compiler
      .
      "/home/arvid/dev/nomadic-labs/mi-cho-coq/coq8.08/_opam/bin/coqc")
     (eval set
           (make-local-variable 'compile-command)
           (concat
            "./logchecker.exe -f "
     ...
     (org-latex-pdf-process
      "latexmk -latexoption='-shell-escape' -xelatex -interaction=nonstopmode -output-directory=%o %f")
     ...
     (org-latex-pdf-process
      ...
      ("xelatex -interaction nonstopmode -output-directory %o %f"
       "xelatex -interaction nonstopmode -output-directory %o %f"))
     (coq-prog-name
      . "/home/arvid/dev/nomadic-labs/mi-cho-coq/_opam/bin/coqtop")
     (coq-top
      . "/home/arvid/dev/nomadic-labs/mi-cho-coq/_opam/bin/coqtop")
     (coq-compiler
      . "/home/arvid/dev/nomadic-labs/mi-cho-coq/_opam/bin/coqc")
     (org-link-file-path-type . relative)
     (org-link-file-type . relative)
     (orch-image-dir
      .
      "/home/arvid/Data/Onebox/Research/Thesis/Soutenance/presentation/figures/")
     (ispell-personal-dictionary
      .
      "/home/arvid/Data/Onebox/Research/Thesis/arvid_jakobsson_phd_thesis/.aspell.fr.pws")
     (eval ispell-change-dictionary "french" nil)
     (org-latex-pdf-process
      "pdflatex -shell-escape talk_frank2018.tex")
     (eval progn
           (add-to-list
            'LaTeX-verbatim-macros-with-braces-local
            "bsplibprimitivesec")
           (add-to-list
            'LaTeX-verbatim-macros-with-braces-local "rsevalprog"))
     (eval when
           (and (buffer-file-name)
                (string-suffix-p ".tex" (buffer-file-name) t))
     ...
     (orch-image-dir
      .
      "/home/arvid/Data/Onebox/Research/Thesis/arvid_jakobsson_phd_thesis.test/figures")
     (ispell-personal-dictionary
      .
      "/home/arvid/Data/Onebox/Research/Thesis/arvid_jakobsson_phd_thesis.test/.aspell.en.pws")
     (TeX-command-extra-options . "-shell-escape")
     (uniquify-min-dir-content . 1)
     (eval when
           (and (buffer-file-name)
                (string-suffix-p ".tex" (buffer-file-name) t))
           (message (concat "X: Opening " (buffer-file-name)))
           (ispell-change-dictionary "en_US" nil)
           (flyspell-buffer)
           (flyspell-mode)
           (flycheck-mode)
     ...
     (orch-image-dir
      .
      "/home/arvid/Data/Onebox/Research/Thesis/arvid_jakobsson_phd_thesis/figures")
     (fci-mode . t)
     (eval when
           (and (buffer-file-name)
                (string-suffix-p ".tex" (buffer-file-name) t))
           ...
           (flyspell-buffer)
           (flyspell-mode))
     (eval message (concat "X: Opening " (buffer-file-name)))
     (orch-image-dir
      . "/home/arvid/Data/Onebox/Research/Thesis/meta/figures")
     (org-catch-invisible-edits . error)
     (org-refile-targets (:maxlevel . 3))
     (org-refile-targets)
     (eval progn
           (ispell-change-dictionary "en_US" nil)
           (flyspell-buffer)
     ...
     (ispell-personal-dictionary
      .
      "/home/arvid/Data/Onebox/Research/Thesis/arvid_jakobsson_phd_thesis/.aspell.en.pws")
     ...
     (org-latex-pdf-process
      "pdflatex -shell-escape talk_tezos2018.tex")
     ...
     (ido-max-directory-size . 1000000)
     (org-latex-pdf-process
      "pdflatex -shell-escape talk_cea2018v2.tex")
     ...
     (ethan-wspace-errors quote (tabs eol no-nl-eof many-nls-eof))
     (indent-tabs-mode nil)
...
(custom-set-faces
 ...
 '(whitespace-line
   ((t
     (:inherit
      nil
      :underline (:color "#e4c340" :style wave :position nil))))))
