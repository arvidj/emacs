...
(unless vimperator-mode-keymap
  ...
  (define-key
   vimperator-mode-keymap (kbd "C-c C-c") 'vimperator-commit))

(define-minor-mode vimperator-mode
  "Minor mode for editing inputs from vimperator."
  :lighter " vimp"
  :keymap
  vimperator-mode-keymap
