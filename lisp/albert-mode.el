...
(defcustom albert-indent-comments nil "Shall we indent comments")
          ...
          (if (non-empty-line )
              (cond
               ((is-definition-start-line)       ;definition start at 0
                (message "albert-indent-line : non-empty line indented as definition")
                (setq current-indent albert-definition-indent)
                )
                     ...
                     (if (non-empty-line )
                         (cond
                          ...
                          ((and (non-empty-line) (not (is-comment))) ;text is aligned with previous non-empty, non-header/comment line
                           ...
                           (setq not-indented nil))
                          ((bobp)                   ;align at zero if no previous text
                           (message "albert-indent-line : non-empty indented on first line")
...
(define-generic-mode 'albert-mode
  ;; comments:
  '("//")
  ;; keywords:
  ...
  ( list
    (lambda () (set (make-local-variable 'indent-line-function) 'albert-indent-line))
