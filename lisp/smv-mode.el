...
(defconst smv-keywords
  '("MODULE" "VAR" "TRANS" "ASSIGN" "INVAR" "DEFINE" "SPEC" "process" "array"
    "FAIRNESS" "case" "esac" "AG" "EG" "AF" "EF" "AX" "EX" "U" "of" "mod"
    "for" "WORDS" "WORDDEFINE" "boolean" "next" "init" "INIT" "powerof2"
    "wordconst" "toword" "self" "in" "notin" "COMPUTE" "MAX" "MIN" "PRINT"
    "hide" "expose")
  "The list of SMV keywords.")

(defconst smv-declaration-keywords
  '("MODULE" "VAR" "TRANS" "ASSIGN" "INVAR" "DEFINE" "SPEC"
    "FAIRNESS" "WORDS" "WORDDEFINE" "INIT")
