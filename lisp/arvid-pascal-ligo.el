...
(setq pligo-font-lock-keywords
      (let* (
             ;; define several category of keywords
             (x-keywords '("function" "type" "is" "record" "end" "const" "var" "block" "case" "of" "else" "with"))
             (x-types '("nat" "map" "address" "big_map" "contract" "string" "bool" "None" "Some"))
...
(define-derived-mode pligo-mode fundamental-mode "pascal-ligo-mode"
