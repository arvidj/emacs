...
(defun aj/sgml-mode-hook ()
  ...
  (define-key sgml-mode-map (kbd "C-c th") 'aj/tag-wrap-header-line-or-region)
  (define-key sgml-mode-map (kbd "C-c tt") 'aj/tag-wrap-line-or-region)
  (define-key sgml-mode-map (kbd "C-c tp") (lambda () (interactive) (aj/tag-wrap-line-or-region "p")))
  (define-key sgml-mode-map (kbd "C-c te") (lambda () (interactive) (aj/tag-wrap-line-or-region "em")))
  (define-key sgml-mode-map (kbd "C-c ts") (lambda () (interactive) (aj/tag-wrap-line-or-region "strong")))

  (modify-syntax-entry ?\' "." html-mode-syntax-table))

(use-package sgml-mode
  :config
  (add-hook 'sgml-mode-hook 'aj/sgml-mode-hook))
