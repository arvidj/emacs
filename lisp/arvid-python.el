(setenv "PATH"
        (concat "/home/arvid/.pyenv/shims" ":" (getenv "PATH")))
...
(defun my-python-hook ()
  ...
  (define-key
   python-mode-map (kbd "C-c t r") 'pytest-one-regtestreset)
...
(use-package
 ...
 :config (add-hook 'python-mode-hook 'my-python-hook))
...
;; automatically:
(use-package pyenv-mode :commands pyenv-mode :ensure t)
...
(use-package pydoc-info :after python :ensure t)
